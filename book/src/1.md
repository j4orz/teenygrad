...
- [1. Representing *Data* with High Dimensional Stochasticity]()
  - [1.1 Propositionally Deductive ELIZA to Probabilistically Inductive ChatGPT](#11-from-logically-deductive-software-10-of-eliza-to-probabilistically-inductive-software-20-of-chatgpt)
  ...
  - [1.5 High Dimensional Stochastic Data with Random Vectors of a Coordinate Space]()
  - [1.6 Linear Transformations: Matrices and their Determinants]()
  ...
  - [1.9 Dimensionality Reduction with Subspace Learning via Principal Component Analysis](#19-dimensionality-reduction-with-subspace-learning-of-principal-component-analysis)
...
- [3. Accelerating *Functions* and *Data* with Basic Linear Algebra Subroutines](#3-accelerating-functions-and-data-with-basic-linear-algebra-subroutines-in-teenygrad)
  ...
  - [3.1 Accelerating the BLAS: Processor Pipelines and Memory Hierarchies]()
...
### 1.1 From Logically Symbolic Software 1.0 of ELIZA to Probabilistically Dimensional Software 2.0 of ChatGPT
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>

> Q: What is the difference between the programs of software 1.0 and software 2.0?</br>
> A: Software 1.0 programs **specify logically deductive instructions** and Software 2.0 programs **recover probabilistically inductive distributions**
...
which is used to represent data in *higher dimensions*:
  - [1.5 High Dimensional Stochastic Data with Random Vectors of a Coordinate Space]()
  - [1.6 The Geometry of Coordinates via Inner Products: Norms, Distances, Angles, Projections]() <!-- angles? rotation? orthogonality? (projection) -->
...
> A<span class="sidenote-number"></span><span class="sidenote">*Predicted by philosophical and linguistic work by (Wittgenstein 1953), (Harris 1954), and (Firth 1957). That is, "the meaning of a word is its use in the language", and similarly, "You shall know a word by the company it keeps".*</span>: As **high dimensional random vectors $\mathbf{X}=\mathbf{x}$ in coordinate spaces $\reals^d$**

Historically speaking, the first ways in which artificially intelligent systems (such as ELIZA)
initially represented the meaning of words (referred to as semantics) was to use symbolic representations as a string of letters
(or an index into a list of strings of letters),
referred to as <span class="defnote">**lexical semantics**</span>**lexical semantics**.
...
There is something left to be said about this representation of word meaning.

Another possible idea is to represent word meaning by the idea, concept, or sense that the word encodes,
referred to as <span class="defnote">**denotational semantics**</span>**denotational semantics**.
The classic example is WordNet, available through the Natural Language Toolkit Python package `nltk`:
...
In addition to the key-value dictionary-like capability of the denotational representation,
...
from nltk.corpus import wordnet as wn
synsets = wn.synsets("life")
hypernyms = [h for s in synsets for h in s.hypernyms()]
print("synonyms of life:", wn.synonyms("life"))
print("hypernyms of life:", [h.lemma_names() for h in hypernyms])
```

<span class="defnote">**similarity**</span>**similarity** with shortest paths
...
Although denotational representations like WordNet are a major improvement over lexical representations,
The failure of wordnet is the same reason why part of GOFAI failed. symbolic representations?
(todo, denotatinal representation vs localist representation?)
problem of <span class="defnote">**localist representations**</span>**localist representations** is evaluating similarity.
could try to rely on wordnet's list of synonyms to get similarity.
but it's well-known (empirically?) to fail badly: incomplete. idea; maybe we can encode similarity in the representations themselves?

<span class="defnote">**distributional semantics**</span>**distributional semantics**
<span class="defnote">**vector semantics**</span>**vector semantics**

> Q: How do language models represent the **meaning of words?** </br>
> A<span class="sidenote-number"></span><span class="sidenote">*Predicted by philosophical and linguistic work by (Wittgenstein 1953), (Harris 1954), and (Firth 1957). That is, "the meaning of a word is its use in the language", and similarly, "You shall know a word by the company it keeps".*</span>: As **high dimensional random vectors $\mathbf{X}=\mathbf{x}$ in coordinate spaces $\reals^d$**

visualization below $\mathbf{x}\in\reals^{200}$
...
<div class="full-bleed">
<iframe height="750px" loading="lazy" src="https://tiktokenizer.vercel.app/" class="playground-iframe">></iframe>
</div>
