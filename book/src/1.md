...
## I. Table of Contents
- [**1. Representing *Data* with High Dimensional Stochasticity**](#1-representing-data-with-high-dimensional-stochasticity-in-torch)
...
- [**3. Accelerating *Functions* and *Data* with Basic Linear Algebra Subroutines**](#3-accelerating-functions-and-data-with-basic-linear-algebra-subroutines-in-teenygrad)
  ...
  - [**3.4 Accelerating the BLAS: Instruction Sets, Pipelines and Hierarchies**](#34-accelerating-the-blas-instruction-sets-pipelines-and-hierarchies)
