...
- [1. Representing *Data* with High Dimensional Stochasticity in `torch`]()
  ...
  - [1.9 Dimensionality Reduction with Principal Component Analysis]()
...
To build SITP's capstone model project<span class="sidenote-number"></span><span class="sidenote">*Which you will train once with `torch` and another time with `teenygrad`, SITP's capstone framework project*</span>
