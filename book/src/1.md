...
- [2. Learning *Functions* From Data with `pytorch`](#2-learning-functions-from-data-with-pytorch)
  ...
  - [2.2 Training Linear Regression by Directly Optimizing Squared Error Loss](#22-training-linear-regression-by-directly-optimizing-squared-error-loss)
  - [2.3 Predicting Categories by Linearly Modeling Classification]()
  - [2.4 Training Logistic Regression by Iteratively Optimizing Cross Entropy Loss]()
...
### 2.2 Training Linear Regression by Directly Optimizing Squared Error Loss
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>
