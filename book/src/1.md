...
## Table of Contents
- [1.1 Statistical Learning of Continuously Stochastic *Data* with `numpy`](#11-statistical-inference-of-stochastic-data-with-python)
...
- [1.2 Machine Learning of Continuously Stochastic *Functions* with `numpy`](#12-statistical-learning-of-continuously-stochastic-function-with-numpy)
...
> We<span class="sidenote-number"></span><span class="sidenote">*The following is a software2.0-adapted excerpt from The Structure and Interpretation of Computer Programs [Chapter 1: Building Abstractions with Procedures](https://mitp-content-server.mit.edu/books/content/sectbyfn/books_pres_0/6515/sicp.zip/full-text/book/book-Z-H-9.html#%_chap_1):*</span> are about to study the idea of a computational process. Computational processes are abstract beings that inhabit computers. As they evolve, processes manipulate other abstract things called data. The evolution of a process is directed by a pattern of ~~rules called a program~~ <a href="">*probabilities called a model*</a>. People create ~~programs to direct processes~~ <a href="">*models to recover processes*</a>. In effect, we conjure the spirits of the computer with our spells.</br></br>
...
have already been made by our mathematical cousins a few hundred years ago during the 15th century.
In the next three chapters of
  - [1.1.1 Distributing Truth Stochastically with Probabilities]()
  - [1.1.2 Probabilities on Equally Likely Events with Elementary Combinatorics]()
  - [1.1.3 Probabilities on Events with Rules: Sum Rule, Product Rule, Bayes Rule]()

we will place our focus on the transition from deterministic to continuous descriptions with probability theory's *probabilities*,
and in the next two, move it to the transition from discrete to continuous descriptions with linear algebra's *coordinates*:
  - [1.1.4 Representing Types in Higher Dimensions with the Coordinates]()
  - [1.1.5 Linear Transformations with Matrix-Vector Multiplication]()
...
![](./assets/plato-aristotle.jpg)
<small>*Plato and Aristotle in The School of Athens, Raffaello Sanzio da Urbino 1509-1511.*</small></br>

### 1.1.1 Distributing Truth Stochastically with Probabilities

The first logician (and in some sense, the first compiler writer) was a man born 2000 years ago named
[Aristotle](https://plato.stanford.edu/entries/aristotle/),
as he discovered and created the formal logical structures that were embedded within natural language
into a description referred to as a *logic*<span class="sidenote-number"></span><span class="sidenote">*Although there are many limitations with [Aristotelian Logic](), with no one claiming it serves as a sufficient basis for everyday reasoning, proof assistants, nor programming languages, many scholars trained in formal techniques have come to appreciate how far Aristotle's went with so little to build from. When the height of mathematics moved from Greece to the Middle East, Aristotle was known amongst the medeival Hindu-Arabic scholars as "The First Teacher"*</span>
