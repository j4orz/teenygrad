...
## I. Table of Contents
- [1. Learning Continuously Stochastic *Distributions $X$* From Data with `numpy`](#1-statistical-learning-of-continuously-stochastic-data-with-numpy)
...
- [2. Learning Continuously Stochastic Linear *Models $f\colon X\to Y$* From Supervised Data with `numpy`](#2-learning-continuously-stochastic-linear-models--from-data-with-numpy)
  - [2.1 Supervised Learning and Two Cultures of Statistical Modeling: Inference vs Prediction]()
  - [2.2 Quantitative Prediction with Linear Regression by Directly Optimizing Squared Error Loss]()
  - [2.3 Categorical Prediction with Logistic Regression by Iteratively Optimizing Cross Entropy Loss]()
...
## 1. Learning Continuously Stochastic *Distributions $X$* From Data with `numpy`
...
## 2. Learning Continuously Stochastic Linear *Models $f\colon X\to Y$* From Data with `numpy`
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
In chapter 1, you've started the transition from software 1.0 to software 2.0 by

1. using *random variables* instead of *deterministic variables*
by distributing the *truth* values you are used to onto a weighted set of events with the language of probability theory,
as well as representing *types* in high dimensional coordinate systems with the language of linear algebra.
...
In chapter 2, rather than recover a single random variable $X$ from data,
we will recover two random variables $X$ and $Y$ from data in order to create a *model* $f\colon X \to Y$.

### 2.1 The Two Cultures of Statistical Modeling: Understanding and Prediction
...
with some function $f\colon \mathcal{X} \to \mathcal{Y}$.
