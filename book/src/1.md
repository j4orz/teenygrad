...
- [1. Representing *Data* with Highly Dimensional Stochastic Distributions in `torch`](#1-representing-data-with-highly-dimensional-stochastic-distributions-in-torch)
  ...
  - [1.3 The Algebra of Probabilities: Sum Rule, Product Rule, and Bayes Rule](#13)
...
- [2. Learning *Functions* from *Data* with Optimization in `torch`](#2-learning-functions-from-data-with-optimization-in-torch)
  ...
  - [2.1 Predicting Scalars by Linearly Modeling Regression](#21-linearly-modeling-regression-by-directly-optimizing-squared-error-loss)
  - [2.2 Fitting Linear Regression by Directly Optimizing Squared Error Loss]()
  - [2.3 Predicting Categories by Linearly Modeling Classification]()
  - [2.4 Fitting Logistic Regression by Iteratively Optimizing Cross Entropy Loss]()
  - [2.5 ??]() <!-- Generalized Linear Models, Generalization, Bias-Variance Tradoff, and Double Descent -->
...
### 1.5 Recovering Probabilities from Data with Parameter Estimation via Maximum Likelihood
...
### 1.6 Representing Types *Continuously in Higher Dimensions* with Coordinates
<div class="full-bleed">
...
### 1.7 The Linear Algebra of Coordinates: Matrices
...
### 1.8 Learning Probabilities from Data with Maximum Likelihood Estimation
...
### 2.1 Predicting Scalars by Linearly Modeling Regression
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>
