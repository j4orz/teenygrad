...
## Table of Contents
- [1.1 Learning Continuously Stochastic *Distributions* From Data with `numpy`](#11-statistical-learning-of-continuously-stochastic-data-with-numpy)
  - [1.1.1 From Deductive Software 1.0 to Inductive Software 2.0]()
  - [1.1.2 Distributing Truth Stochastically with Probabilities]()
  - [1.1.3 Probabilities of Equally Likely Events with Elementary Combinatorics]()
  - [1.1.4 Probabilities of Events Composed with Sum, Product, and Bayes Rule]()
  - [1.1.5 Representing Types in Higher Dimensions with Coordinates]()
  - [1.1.6 Linear Transformations with Matrix-Vector Multiplication]()
  - [1.1.7 Random Variables with their Distributions, Expectations, and Variance]()
  - [1.1.8 Probabilities from Data with Parameter Estimation via Maximum Likelihood]()
  - [1.1.9 Probabilities from Data Redux with Parameter Estimation via Maximum a Posteriori]()
- [1.2 Learning Continuously Stochastic Linear *Models* From Data with `numpy`](#12-machine-learning-of-continuously-stochastic-function-with-numpy)
  - [1.2.1 Supervised Learning: Functions from Data]()
  - [1.2.2 Predicting Scalars with Linear Models and Direct Optimization]()
  - [1.2.3 Predicting Categories with Linear Models and Iterative Optimization]()
  - [1.2.4 ??]() <!-- Generalized Linear Models, Generalization, Bias-Variance Tradoff, and Double Descent -->
- [1.3 Programming CPU Accelerated Basic Linear Algebra Subroutines with `teenygrad.Tensor`](#13-programming-cpu-accelerated-basic-linear-algebra-subroutines-with-teenygradtensor)
  ...
  - [1.3.4 Accelerating Basic Linear Algebra Subroutines in Rust: Pipelines and Hierarchies]()
...
In the next three chapters we will place our focus on the transition from deterministic to continuous descriptions with *probabilities* of a *probability space*
  - [1.1.2 Distributing Truth Stochastically with Probabilities]()
  - [1.1.3 Probabilities on Equally Likely Events with Elementary Combinatorics]()
  - [1.1.4 Probabilities on Events with Rules: Sum Rule, Product Rule, Bayes Rule]()
...
in addition to *analytic probabilities*:
  - [1.1.7 Random Variables with their Distributions, Expectations, and Variance]()
  - [1.1.8 Probabilities from Data with Maximum Likelihood Estimation]()
...
### 1.2.2 $f\colon \reals^d \to \reals$ Linear Regression, Squared Loss, and Direct Optimization of Normal Equations

<!-- ### 1.2.3 Fitting a Line with the Direct Optimization of Normal Equations -->
...
### 1.2.3 Sigmoidal Classification with Cross Entropy Loss, and Iterative Optimization of Gradient Descent
