...
although early artificial intelligence in
- game playing (checkers, chess)
- puzzles
- mathematics (logic theorist, student)

given our quest to understand and build our own ChatGPT,
our focus will be conversational machines that wanted to pass the turing test.
