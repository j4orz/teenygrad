...
For instance, modeling the "experiment" or phenomena of language with probability theory, the vocabulary we've previously encountered with formal language theory is now seen as the sample space:
