...
<!-- 3. BLAS -->
- [1. Representing *Data* with High Dimensional Stochasticity using `teenygrad`](#1-representing-data-with-high-dimensional-stochasticity-in-numpy)
...
- [2. Learning *Functions* from *Data* with Parameter Estimation using `teenygrad`](#2-learning-functions-from-data-with-parameter-estimation-in-numpy)
...
- [3. Accelerating *Functions* and *Data* on `CPU` implementing `teenygrad`](#3-accelerating-functions-and-data-with-basic-linear-algebra-subroutines-in-teenygrad)
...
### 1.5 Learning Probabilities from Data by Counting Frequencies
<small>[$\hookleftarrow$ Table of Contents](#i-elements-of-networks-1)</small>
