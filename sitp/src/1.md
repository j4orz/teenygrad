...
We can do this in Python with <span class="defnote">**regular expressions**</span>**regular expressions** — accessible via standard library's [`re`](https://docs.python.org/3/library/re.html) module —
