...
- [0. From Symbolic Software 1.0 to Stochastic Software 2.0](#0-from-logical-software-10-to-stochastic-software-20)
  ...
  - [0.3 Wood's Understanding with the Logic of `LUNAR`]()
  - [0.4 X's Understanding with the Semantic Network of `foobar`]()
...
### 0.6 Lenat's Bitter Lesson: From A Logical to Distributional Semantics
