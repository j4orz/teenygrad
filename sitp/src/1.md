...
- [2. Syntactic Sequence Learning Redux: with Linear Models](#2-syntactic-sequence-learning-redux-with-linear-models)
  ...
  - [2.2 Predicting Categories by Linearly Modeling Classification](#25-predicting-categories-by-linearly-modeling-classification) <!-- $f: \reals^d \to \N$ -->
  - [2.3 Iteratively Fitting Logistic Regression with Cross Entropy Loss]() <!-- $\mathscr{L(\theta)} := $ -->
  - [2.4 Summary]()
