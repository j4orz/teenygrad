...
- [*Intermezzo One: The Language of Set Theory and Logic*](#intermezzo-one-the-language-of-dependent-type-theory)
- [1. Syntactic Sequence Learning with n-gram Models](#1-syntactic-sequence-learning-with-n-gram-models)
  ...
  - [1.4 Predicting Categories by Linearly Modeling Classification](#25-predicting-categories-by-linearly-modeling-classification) <!-- $f: \reals^d \to \N$ -->
...
- [2. From Abstract to Numerical Linear Algebra](#3-from-abstract-to-numerical-linear-algebra)
  - [2.1 From Virtual to Physical Machines](#31-from-virtual-to-physical-machines) <!-- three language problem: rust translation and risc-v evaluation -->
  - [2.2 From Virtual to Physical Shapes](#32-from-virtual-to-physical-shapes) <!-- strides and layouts -->
  - [2.3 Accelerating Basic Linear Algebra Subroutines]()
  - [2.4 Accelerating Communication with Hierarchies]()
  - [2.5 Accelerating Computation with Pipelines]()
  - [2.6 Summary]()
...
## 2. Syntactic Sequence Learning Redux: with Linear Models
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
