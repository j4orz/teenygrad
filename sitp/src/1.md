...
- [1. Syntactic Sequence Learning via n-gram Models with `teenygrad`]()
  ...
  - [1.2 Intermezzo One: The Language of Logic](#12-intermezzo-one-the-language-of-dependent-type-theory)
  ...
  - [1.7 Intermezzo Two: The Language of Probability Theory](#18-intermezzo-two-the-language-of-probability-theory)
  - [1.8 From Evaluating to Recovering Probabilities with Statistics]()
...
- [2. Semi-Automated Semantic Sequence Learning via Linear Models with `teenygrad`]()
  ...
  - [2.2 Intermezzo Three: Descending Into The Language of Linear Algebra](#22-intermezzo-three-the-language-of-linear-algebra)
  ...
  - [2.7 Intermezzo Four: Descending Into The Language of Analysis, Calculus, and Optimization](#28-intermezzo-four-the-language-of-analysis-calculus-and-optimization)
...
#### 1.1.2 An Attempt at Common Sense with CYC

##### 1.1.2.1 A Richer Lexical Semantics with WordNet
...
##### 1.1.2.2 Knowledge Representation

##### 1.1.2.2 Knowledge Reasoning


#### 1.1.3 The Bitter Lesson: From Tractatus to Investigations
...
### 1.2 Intermezzo One: The Language of Logic
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
