...
- [2. Semi-Automated Semantic Sequence Learning with Linear Models]()
  - [0.6 Markov's Next Token Prediction As Massively Multi-Task Learning]() <!-- various tasks: sentiment, translation, question answering -->
...
The core interest of such theory are the syntactical aspects of languages,
and namely the <span class="defnote">**membership problem**</span>**membership problem**: to determine based off structural form whether a given string is in a language or not.
