...
So with that all said, go on young hacker. Venture forth! Do not think too much. And just do.
...
represented the meaning of words was to do the obvious thing and use strings of letters
...
Clearly, there is something left to be said about this representation of word meaning,
namely, that this representation of word meaning is not amenable to encoding
multiple meanings — referred to as concepts or <span class="defnote">**sense**</span>**senses** —
...
since that the meaning associated to the words we use on a daily basis can change depending on the context.
For instance, according to the Merriam Webster dictionary<span class="sidenote-number"></span><span class="sidenote">*The same activity can be with the Cambridge and Oxford dictionaries. Pick your favorite!*</span>, a few meanings or senses of the word "life" includes:
- the quality that distinguishes a vital and functional being from a dead body
- the sequence of physical and mental experiences that make up the existence of an individual
- spiritual existence transcending (see transcend sense 1c) physical death

Given that the problem with the basic string representation is the lack of multiple *associations*
(the meaning of life is just `"LIFE"`), perhaps we can use a *dictionary* data structure, which *literally* gets its name from word dictionaries?
