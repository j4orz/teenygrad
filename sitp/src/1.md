...
That principle is the distinction between **syntactical form**<span class="defnote">**syntax**</span> and **semantic meaning**<span class="defnote">**semantics**</span>, which practitioners
...
ELIZA's **representation** is `str`s, and it does not perform any **reasoning** whatsoever.
Perhaps we simply need to build a natural language processing system with stronger syntactic and semantic analysis?
