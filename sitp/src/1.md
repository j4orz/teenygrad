...
- [1. Syntactic Sequence Learning with n-gram Models]()
  - [1.1 Markov's Next Token Prediction As Massively Multi-Task Learning](#11-markovs-next-token-prediction-as-massively-multi-task-learning)
  - [1.2 From Certain to Uncertain Knowledge]() <!-- Probability -->
  - [1.3 Probability as Array Programming]() <!-- Sums, Products, and Conditionals -->
  - [1.4 Random Variables and their Distributions]() <!-- Expectations, and Variance -->
  - [1.5 From Evaluating to Recovering Probabilities]() <!-- Statistics -->
  - [1.6 Summary]()
...
- [3. From Abstract to Numerical Linear Algebra](#3-from-abstract-to-numerical-linear-algebra)
  ...
  - [3.3 From Abstract to Numerical Linear Algebra](#33-from-abstract-to-numerical-linear-algebra)  <!-- : Real to Floating Arithmetic -->
  - [3.4 Accelerating Basic Linear Algebra Subroutines]()
  - [3.5 Accelerating Communication with Hierarchies]()
  - [3.6 Accelerating Computation with Pipelines]()
  - [3.7 Summary]()
...
### 1.1 Markov's Next Token Prediction As Massively Multi-Task Learning
...
### 1.2 From Certain to Uncertain Knowledge
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
## 3. From Abstract to Numerical Linear Algebra
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>

### 3.1 From Virtual to Physical Machines
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>

### 3.2 From Virtual to Physical Shapes
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>

### 3.3 From Abstract to Numerical Linear Algebra
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
### 3.5 Accelerating Communication with Hierarchies via Loop Reordering, Register and Cache Blocking
