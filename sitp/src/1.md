...
It's effectively an escape hatch for `eliza()`'s utter lack of semantic understanding with word meaning.
...
1. First, a compiler needs to conceptually understand what is being spoken to them from the source language
2. Then, said compiler can translate to the target language

#### 0.3.1 Understanding the Source
...
#### 0.3.2 Translating to the Target
