...
- [0. From Symbolic Software 1.0 to Stochastic Software 2.0](#0-from-logical-software-10-to-stochastic-software-20)
  ...
  - [0.3 Wood's Understanding with McCarthy's Logic of `LUNAR`]()
  - [0.4 X's Understanding with Minsky's Frames of `foobar`]()
  - [0.5 Feigenbaum's Narrow Expertise with the _ of `DENDRAL`]()
...
> In which we retrace the development and failure of the discretely symbolic approach to building artificially intelligent machines motivating the need to transition from deterministically discrete software 1.0 to the stochastically continuous software 2.0 with the following chapter.
...
### 0.3 Wood's Understanding with McCarthy's Logic of `LUNAR` and `SHRDLU`
early q&a systems
...
### 0.4 X's Understanding with Minsky's Semantic Networks of `foobar`
semantic networks
...
For GOFAI techniques, refer to [(Eisenstein 2018)'s](https://github.com/jacobeisenstein/gt-nlp-class/blob/master/notes/eisenstein-nlp-notes.pdf) Chapter 9, 10, 11, 12, 13 [(Jurafsky and Martin 2026)'s](https://web.stanford.edu/~jurafsky/slp3/) Appendix F, G, H, I, J, K, [(Bird, Klein, and Loper 2009)'s](https://www.nltk.org/book/) Chapter 7, 8, 9, 10 and [(Russel and Norvig 2022)'s](https://aima.cs.berkeley.edu/) Part III (Chapter 7, 8, 9, 10) and Part VI (Chapter 24).
For logical foundations, refer to [(Brachman and Levesque 2004)](https://bista.sites.dmi.unipg.it/didattica/CSP/knowledge-representation-and-reasoning-the-morgan-kaufmann-series-in-artificial-intelligence.pdf), [(Sowa 2000)](https://www.jfsowa.com/krbook/) and [(Genesereth and Nilsson 1987)]().
