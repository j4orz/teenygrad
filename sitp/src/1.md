...
<!-- 3. BLAS -->
- [1. Learning *Data* Distributions with `teenygrad`]()
...
- [2. Learning *Function* Distributions with `teenygrad`]()
  - [2.1 From Learning Distributions of Data to Distributions of Functions]()
...
Programs were intially implemented with machine languages, then assembly languages, with systems languages, and finally high level languages which were so high, that they started feeling English-like. But something was always missing.
...
A classic exemplar of this approach is ELIZA, a computer program which simulates a Rogerian psychotherapist presented in [A Computer Program For the Study of Natural Language Communication Between Man and Machine. (Weizenbaum 1966)](https://dl.acm.org/doi/epdf/10.1145/365153.365168)
...
> [!TIP]
> Try interacting with both ELIZA and the ChatGPT-like Qwen to viscerally feel what the world felt in 2022. To provide a rough comparison with other disciplines, the the manufacturing of the Boeing 747 started and lasted around the same time period.
...
let's first review what kind of methods systems like ELIZA used, which are now known as <span class="defnote">**GOFAI**</span> good old fashioned artificial intelligence, or <span class="defnote">**software 1.0**</span> software 1.0.

---

As mentioned previously, GOFAI's software 1.0 approach to building intelligent machines was to program discrete structures with deterministic descriptions.
Let's take a quick tour of programs with said structures, and their descriptions.

**Strings**

In the case of natural language processing, the first most obvious thing to do
