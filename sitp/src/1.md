...
> In which we retrace the development of the discretely symbolic approach to building artificially intelligent machines with common sense, and ultimately, it's failure to describe a reality with too many parts to count, requiring us to transition to a continuously stochastic approach.
...
In it's proposal<span class="sidenote-number"></span><span class="sidenote">*See [(McCarthy, Minsky, Rochester, Shannon 1955)](https://raysolomonoff.com/dartmouth/boxa/dart564props.pdf)*</span>:
