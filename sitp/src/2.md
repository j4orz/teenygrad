...
- [**5. Accelerating *Sequence Models* on `GPU` in `teenygrad`**](#5-accelerating-sequence-models-on-gpu-in-teenygrad-with-cuda-rust)
  ...
  - [**5.4 From `SIMD` of Multi-Core Latency-Oriented Processors to `SIMT` of Many-Core Throughput-Oriented Processors**](#54-from-simd-of-multi-core-latency-oriented-processors-to-simt-of-many-core-throughput-oriented-processors)
