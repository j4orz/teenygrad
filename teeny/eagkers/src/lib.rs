...
pub fn saxpypy(n: usize, alpha: f32, x: PyBuffer<f32>, y: PyBuffer<f32>) -> PyResult<()> {
  ...
  crate::blas::saxpy(n as i32, alpha, x, 1, y, 1);
  Ok(())
}
...
pub fn sgemmpy(
  ...
  let ta = if transa { crate::blas::Transpose::Ordinary } else { crate::blas::Transpose::None };
  let tb = if transb { crate::blas::Transpose::Ordinary } else { crate::blas::Transpose::None };
  crate::blas::sgemm(crate::blas::Layout::RowMajor, ta, tb, m as i32, n as i32, p as i32, alpha, a, lda as i32, b, ldb as i32, beta, c, ldc as i32);
  Ok(())
}