...
# Of course, if the stochastic phenomena being described is simple enough to model by counting analytically
# such as coin, dice, and cards, we can reason, argue, and justify the construction of the associated probability distribution a priori.
